...
# Train and evaluate
model_ft, hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft, scheduler_ft, num_epochs=num_epochs)
...
# """
# LET'S DO SOME TRAINING BABY
# """
# PATH_TO_DATASET = "D:/256_train_and_val"
# train_loader, val_loader = data_loader(PATH_TO_DATASET)
